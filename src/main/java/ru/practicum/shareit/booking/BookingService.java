...
public interface BookingService {
    ...
    List<BookingDto> findAll(String state, long ownerId) throws ValidationException;

    List<BookingDto> findAllWithOwner(String state, long ownerId) throws ValidationException;
}
